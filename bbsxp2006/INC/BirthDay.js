<!--
document.write("<div id=YuziCalendarLayer style='position: absolute; z-index: 9999; width: 144; height: 193; display: none'>");
document.write("<iframe name=YuziCalendarIframe scrolling=no frameborder=0 width=100% height=100%></iframe></div>");
function writeIframe()
{
    ...
    "td#yuziYearHead, td#yuziYearMonth{color: "+ WebCalendar.wordColor +"}"+
    ...
    "</style></head><body onselectstart='return false' style='margin: 0px' oncontextmenu='return false'><form name=yuzi>";
    ...
    "    <td width=60 id=yuziYearHead  title='点击此处选择年份' onclick='parent.funYearSelect(parseInt(this.innerText, 10))'"+
    "        onmouseover='this.bgColor=parent.WebCalendar.darkColor; this.style.color=parent.WebCalendar.lightColor'"+
    "        onmouseout='this.bgColor=parent.WebCalendar.lightColor; this.style.color=parent.WebCalendar.wordColor'></td>"+
    "    <td width=50 id=yuziYearMonth title='点击此处选择月份' onclick='parent.funMonthSelect(parseInt(this.innerText, 10))'"+
    "        onmouseover='this.bgColor=parent.WebCalendar.darkColor; this.style.color=parent.WebCalendar.lightColor'"+
    "        onmouseout='this.bgColor=parent.WebCalendar.lightColor; this.style.color=parent.WebCalendar.wordColor'></td>"+
    ...
    "    onfocus='this.blur()' style='yuzi:expression(this.disabled=parent.WebCalendar.thisYear==1000)'><input"+
    ...
    "    onfocus='this.blur()' style='yuzi:expression(this.disabled=parent.WebCalendar.thisYear==9999)'></td></tr></table>"+
...
function WebCalendar() //初始化日历的设置
{
    ...
    this.iframe     = window.frames("YuziCalendarIframe"); //日历的 iframe 载体
    this.calendar   = getObjectById("YuziCalendarLayer");  //日历的层
    this.dateReg    = "";           //日历格式验证的正则式

    this.yearFall   = 120;           //定义年下拉框的年差值
    this.format     = "yyyy-mm-dd"; //回传日期的格式
    this.timeShow   = false;        //是否返回时间
    this.drag       = false;        //是否允许拖动 true|false
...
function hiddenCalendar(){getObjectById("YuziCalendarLayer").style.display = "none";};
...
function writeCalendar() //对日历显示的数据的处理程序
{
    ...
    WebCalendar.iframe.yuziYearHead.innerText  = y +" 年";
    WebCalendar.iframe.yuziYearMonth.innerText = parseInt(m, 10) +" 月";
