...
Conn.execute("update [BBSXP_Users] set Userpass='"&md5(RandomCode)&"' where UserName='"&SqlString(UserName)&"'")
%>
...
Conn.execute("update [BBSXP_Users] set Userpass='"&md5(Userpass)&"' where UserName='"&SqlString(UserName)&"'")
...
<table width="333" border="0" cellspacing="1" cellpadding="2" align="center" class="a2">
	<form method="POST" action="RecoverPassword.asp?menu=rejiggerok">
		<input type="hidden" name="UserName" value="<%=HTMLEncode(Request("UserName"))%>">
		<input type="hidden" name="birthyear" value="<%=HTMLEncode(Request("birthyear"))%>">
		<input type="hidden" name="birthmonth" value="<%=HTMLEncode(Request("birthmonth"))%>">
		<input type="hidden" name="birthday" value="<%=HTMLEncode(Request("birthday"))%>">
		<tr>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="a2">
		...
		<tr>
			<td valign="top" class="a3" align="center"><form action="RecoverPassword.asp?menu=rejigger" method="POST">
				...
				用户名称：<input size="25" name="UserName" value="<%=HTMLEncode(CookieUserName)%>"><br>
